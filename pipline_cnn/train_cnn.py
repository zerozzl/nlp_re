...
from pipline_cnn.model import CNN
...
def main(args):
    ...
    if args.pretrained_model_path is not None:
        ...
        model = CNN(len(rela_to_id), len(token_to_id), args.embed_size, args.max_inp_len, args.pf_embed_size,
                    args.conv_kernel_num, args.conv_kernel_size, args.linear_hidden_size,
...
if __name__ == '__main__':
    ...
    parser.add_argument('--conv_kernel_size', type=int,
                        default=3)
    parser.add_argument('--linear_hidden_size', type=int,
                        default=100)
